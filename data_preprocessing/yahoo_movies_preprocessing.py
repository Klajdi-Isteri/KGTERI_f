...
def run(data_folder):
    ...
    while True:
        ...
        kgteri = KGTeriFilter(**kwargs)
        kwargs['dataset'] = kgteri.filter()['dataset']
        flags.append(kgteri.flag)
        paths['kgteri'] = store_mapped_kg(**kgteri._kwargs,
                                          folder=os.path.join(data_folder, 'kgteri'),
                                          name='kg',
