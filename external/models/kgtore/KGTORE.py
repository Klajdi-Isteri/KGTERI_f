...
from .TimeAwareProcessing import TimeAwareProcessing
...
class KGTORE(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            ("_loader", "loader", "loader", "KGTERITSVLoader", None, None)
        ]

        self.autoset_params()

        # Run only one time to create the pickle file containing the users matrices
        # self.app = TimeAwareProcessing(data=self._data)
        # self.app.time_mapping()

        # self._side = self._data.side_information.KGTERITSVLoader.user_item_matrix
        ...
        self._model = KGTOREModel(
            ...
            l_w=self._l_w,
            side = self._side.user_item_matrix,
            alpha=self._alpha,
            beta=self._beta,
            l_ind=self._l_ind,
